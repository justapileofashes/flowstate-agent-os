...
/** Minimal 5-field cron evaluator: "m h dom mon dow". Supports `*`, lists
 *  (1,2,3), ranges (1-5), and steps (* /15). Scans minute-by-minute up to
 *  ~366 days ahead. Cheap enough for the per-routine cadence. */
